...
const TechStack = () => {
  return (
    <section id="stack" className="py-24 relative z-10 border-y border-white/5 bg-white/[0.01]">
      <div className="container mx-auto px-6 max-w-6xl">
        <SectionTitle number="03." title="Used technology" subTitle="Tech Stack" />
        <ScrollReveal>
            ...
            <div className="flex overflow-hidden py-4 [mask-image:linear-gradient(to_right,transparent,white_10%,white_90%,transparent)]">
              <div className="flex gap-12 md:gap-20 py-4 w-max animate-[infinite-scroll_20s_linear_infinite] hover:[animation-play-state:paused]">
                {[...techIcons, ...techIcons].map((tech, index) => (
                  <div key={index} className="flex flex-col items-center justify-center gap-4 text-slate-500 hover:text-sky-400 transition-colors duration-300 group/icon cursor-pointer">
