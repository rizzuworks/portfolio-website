...
const Footer = () => {
  return (
    <footer 
      id="contact" 
      className="relative h-[40vh] md:h-[80vh] flex flex-col items-center justify-center bg-[#050505] overflow-hidden border-t border-white/5"
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        >
            <a 
              ...
              className="group relative px-10 py-5 bg-white text-black text-lg md:text-xl font-bold rounded-full hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:shadow-sky-500/50 flex items-center gap-3"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="w-16 h-16 flex items-center justify-center bg-white/5 border border-white/10 rounded-full text-white hover:bg-blue-600 hover:border-transparent transition-all duration-300 shadow-lg" 
              title="LinkedIn"
            >
