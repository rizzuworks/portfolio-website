...
const Footer = () => {
  return (
    <footer 
      id="contact" 
      className="relative min-h-[60vh] lg:min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-transparent from-10% to-[#050505] to-30% overflow-hidden"
    >
      
      <div className="absolute inset-0 flex flex-col items-center justify-end select-none pointer-events-none z-0 pb-24">
